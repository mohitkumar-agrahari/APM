...
//    public AssetDTO(String sourceKey, String assetName, String assetType, String description, AssetModel parent, Date createdDate, Date updatedDate, String assetLevel) {
//        this(sourceKey, assetName, assetType, description, createdDate, updatedDate, assetLevel);
//        this.parent = parent != null ? parent.getSourceKey() : null;
//    }
